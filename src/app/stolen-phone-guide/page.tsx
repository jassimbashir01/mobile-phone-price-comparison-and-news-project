...
export default function StolenPhoneGuidePage() {
  return (
    <PageShell>
      <Breadcrumb items={[{ label: 'Home', href: '/' }, { label: 'Stolen Phone Guide' }]} />
      ...
      <Section title="Step 1: Find your IMEI">
        <p>
          Dial <strong>*#06#</strong> on the phone to instantly display its
          IMEI number(s). Dual-SIM and eSIM phones show two IMEI numbers —
          you&apos;ll need both.
        </p>
      </Section>
      ...
      <Section title="Step 2: Check PTA/DIRBS status via SMS">
        <p>
          Type the 15-digit IMEI with no spaces or dashes and send it as an
          SMS to <strong>8484</strong>. You&apos;ll get a reply within a few
          minutes with one of these statuses:
        </p>
        <ul className="ml-4 list-disc space-y-1">
          <li><strong>Compliant</strong> — fully PTA-registered, safe to use.</li>
          <li><strong>GSMA Valid (Non-Compliant)</strong> — a genuine device
            not yet registered; you can register and pay tax via DIRBS.</li>
          <li><strong>Non-Compliant</strong> — the IMEI appears duplicated
            or invalid.</li>
          <li><strong>Stolen / Blocked</strong> — reported stolen or lost by
            its original owner. This cannot be unblocked by paying any tax —
            do not buy a phone with this status.</li>
        </ul>
      </Section>
      ...
      <Section title="Step 3: Register an imported or new phone">
        <p>
          ...
          applicable customs duty shown in the portal. Overseas Pakistanis
          and foreign visitors are generally eligible for a longer temporary
          registration window — check the portal for current terms, since
          exact allowances can change.
        </p>
      </Section>
      ...
      <Section title="If your phone is lost or stolen">
        <ol className="ml-4 list-decimal space-y-1">
          ...
          <li>
            ...
            Management System so it gets blacklisted network-wide — this is
            what prevents anyone else from using the device on a Pakistani
            network, even with a different SIM.
          </li>
        </ol>
      </Section>
      ...
      <Section title="Buying a used phone? Do this first">
        <p>
          Always ask the seller to dial *#06# in front of you, then check
          that exact IMEI via SMS to 8484 before paying. A &quot;Stolen/Blocked&quot;
          reply means the phone is worthless for network use in Pakistan —
      ...
      <p className="text-xs text-ink/40">
        Browse{' '}
        <Link href="/price/all-mobiles" className="text-primary hover:underline">
          all mobile phones
        </Link>{' '}
        or check the latest{' '}
