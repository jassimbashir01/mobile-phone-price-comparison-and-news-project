...
export const metadata: Metadata = {
  ...
  description:
    "Browse 4G mobile phones in Pakistan with prices and full specifications.",
  ...
  return (
    <PageShell>
      <CategoryPageContent
        ...
        title="4G Mobile Phones in Pakistan"
        description="Compare 4G mobile phones available in Pakistan, with prices and full specifications."
        phones={phones}
        total={total}
        page={page}
        limit={limit}
